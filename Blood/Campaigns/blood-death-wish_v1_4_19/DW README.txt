...
DEATH WISH ADD ON FOR BLOOD v1.4
*** README ***
...
Part I. Version History, Special Thanks (as of October 2017)

***************************************
***************************************
***************************************

After watching a variety of Lets Play videos on Twitch and Youtube over the last few years, I’ve been slowly making edits here and there to improve Death Wish in every way possible for version version 1.4. Special thanks to the following Youtube channels for creating especially helpful playthroughs on YouTube:

Cubeface (Cubeface21 on Twitch); he does Blood speedruns as well
DemonSlay3r
Emmanuel EXE
Flairphantem
Hippo Cat
...
Pagb666
Renato Acevedo
TheSeriousCacodemon (Seriouscacodemon on Twitch)
Weavaloid
...
===========================
Changes for v1.4 (spoilers)
===========================

I didn’t write down *every* little change I made, but this is most of it:
...
=======================================
v1.4 UPDATE #1: BloodGDX is now available!
=======================================

http://m210.duke4.net/

BloodGDX is a project aimed at porting Blood to modern operating systems.

=======================================
v1.4 UPDATE #2: bMouse Replacement (I haven’t tested this so use at your own risk!)
=======================================
...
=======================================
v1.4 UPDATE #3: Someone from the /vr/ boards got GOG DW working with this:
=======================================
...
A: See Part III. The movies (.smk) and sound (.wav) need to be in the same directory as dw.ini

Q: A cutscene is running really slowly. What’s wrong?
A: This is a program/DOSBox error, not an error with the DW files. Occasionally when this happens it works fine the next time it loads. I’m not sure what causes this error. 
...
A: I only used the vanilla assets for Blood — I didn’t add anything. If you see a problem when you play using BloodGDX or some other port, contact the port developers. 
