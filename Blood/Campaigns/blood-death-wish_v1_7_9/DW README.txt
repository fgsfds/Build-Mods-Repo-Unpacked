...
DEATH WISH ADD ON FOR BLOOD v1.7
*** README ***
...
** Watched some videos from these streamers to help me me fine tune v1.7.
...
Testing for version v1.7 by Nex 
...
Also, special thanks to anyone else who gave Death Wish a write-up, wrote a review, mentioned it on social media, or recorded a video like Gggmanlives, JBlade, Dominic Tarason, Civvie11, etc. — it really helped get the word out!
...
• edits and additions to many levels across the whole campaign (with a focus on more player choice / encounter approach variety)
