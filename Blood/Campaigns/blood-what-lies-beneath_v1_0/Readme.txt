...
1. INSTALLATION
2. SUPPORTED PORTS
3. WHY NOT OTHER PORTS?
4. WHAT ESLE TO SAY?
5. KNOWN BUGS
6. ASSET ACKNOWLEDGEMENTS
...
Intalling FULL voxels (with the voxel pack) is only recommended fo BEEFY PCs!
...
If any error occures during installation it will be documented in the logfile "WLBINST.LOG". Just open the file with a text editor and check it.
...
3. WHY NOT OTHER PORTS?______________________________________________________________________________________________________________________________________________________________________
...
WLB21.MAP and WLB23.MAP    ->   In both maps there are two big closed off room where you have to fight a lot of enemies to progress.
                                ...
                                So please save at the beginning of these maps. Sorry for the inconvenience.
______________________________________________________________________________________________________________________________________________________________________
